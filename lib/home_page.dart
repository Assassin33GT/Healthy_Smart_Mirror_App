import 'dart:io';
import 'package:demo/change_name.dart';
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              ...
                              backgroundColor: const Color.fromARGB(255, 207, 69, 231),
                            ),
                              onPressed: (){
                          ...
                          ElevatedButton(
                            ...
                            onPressed: (){
                              ...
                              Navigator.push(context, MaterialPageRoute(builder: (context) => ChangePassword(user!.email.toString())));
                          },
                          child: Text(
                            "Change password",
                            style: TextStyle(
