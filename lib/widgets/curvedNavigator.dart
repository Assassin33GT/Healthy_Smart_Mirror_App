    ...
    return CurvedNavigationBar(
               ...
               onTap: (index) {
                ...
                if(index == 0){
                  ...
                  Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => ActivityPage()), (route) => false);
                }else if(index == 2){
                  _openCamera();
                }else if(index == 3){
                  Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => NotificationPage()), (route) => false);
                }else if(index == 4){
                  Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => SupportChatPage()), (route) => false);
                }
               },
    );
  }
